...
export const KEYWORD_ALERT = 'ALERT';
export const KEYWORD_ALERT_2 = 'ALERT_2';
...
export const SYNTAX_SEMICOLON_2 = 'SEMICOLON_2';
export const SYNTAX_STRING = 'STRING';
export const SYNTAX_STRING_2 = 'STRING_2';
...
export const ACTION_EXECUTE_2 = 'EXECUTE_2';
